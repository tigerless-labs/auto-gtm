...
<p align="center">
  <img src="https://img.shields.io/badge/release-v0.2.26-brightgreen.svg" alt="release" />
...
- **topic-scout**: one topic report for any platform, no questions asked. (a) Every product topic — launch-worthy highlights *and* what you shipped, from your recent GitHub PRs; (b) recent hotspots in full — a full builder digest (X / blogs / podcasts, summarized per builder and episode) plus other hot topics from your data layer, every item with its source link.
