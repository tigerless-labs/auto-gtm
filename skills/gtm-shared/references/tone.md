...
Samples calibrate how it sounds. The opinions stay the user's own. These blocks hold posts, so they serve the post drafters only: a comment-draft skill takes its tone from the thread it answers.
