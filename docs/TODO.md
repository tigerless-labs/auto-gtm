...
- **`x-auto-comment-draft` 的身份化改写**：另外三个 drafting skill 已换成「身份定义在前、审美约束退场」的形状（见 [`plans/x-drafter-identity-first.md`](plans/x-drafter-identity-first.md)）；它本轮只修了指向已删章节的悬空引用，身份段与删约束尚未做。
