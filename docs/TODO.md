...
- **topic-scout builder-pulse「in full」与合并排序措辞打架**：Part b 第 1 步要求 builder digest **完整**（分组、逐条一行、只丢无链接项），第 4 步又要求把热点**合并排序**，两条在实操中互相拉扯——一次真实运行里 21 条 X 只落了 8 条。待收紧：明确 builder digest 是不可裁剪的独立小节，排序只作用于其余热点源。
