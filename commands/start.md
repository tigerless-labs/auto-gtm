---
description: Start the auto-gtm go-to-market flow — orient a marketing request and route it to the right skill.
...
- Keep every auto-gtm rule: read-only data, stop at each human checkpoint.
